...
public enum AlignmentEnum
{
	...
	LG(
			"Lawful",
			"Good",
			"Lawful Good is known as the 'Saintly' or 'Crusader' alignment. A Lawful Good character typically acts with compassion, and always with honor and a sense of duty. Lawful Good characters, especially paladins, may sometimes find themselves faced with the dilemma of whether to obey law or good when the two conflict—for example, upholding a sworn oath when it would lead innocents to come to harm—or conflicts between two orders, such as between their religious law and the law of the local ruler."),
	LN(
			"Lawful",
			"Neutral",
