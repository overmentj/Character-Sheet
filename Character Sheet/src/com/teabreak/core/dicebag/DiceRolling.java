...
public class DiceRolling
{
	...
	/**
	 * Takes the number of D6 to roll (values of best n used) to determine the
	 * value of a stat.
	 * 
	 * @param numDice
	 *            the number of dice rolled (3,4 or 5 at present)
	 * @param bestOf
	 *            the best n dice used to generate the value
	 ...
	 * 
	 * @param method
	 *            gives information on how to set the dice
	 * @return dice value
	 */
